...
import { addXp, updateLesson } from '@/lib/learning-api';
...
function QuizInner() {
  ...
  useEffect(() => {
    ...
    if (xpGained > 0) {
      void addXp(authFetch, xpGained).catch(() => {});
    }
  ...
  }, [finished, lesson, pct, score, authFetch]);
        ...
        <div className="card p-8 text-center">
          ...
          {score > 0 && (
            <div className="mt-6 flex items-center justify-center gap-2 rounded-xl bg-yellow-50 py-3 text-yellow-800">
              ...
              <span className="font-bold">+{score * XP_PER_CORRECT_ANSWER} XP Earned!</span>
            </div>
          )}
