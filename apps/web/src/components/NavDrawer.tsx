  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        ...
        aria-label={title}
        tabIndex={-1}
        className="fixed inset-y-0 left-0 z-[100] flex w-[85%] max-w-sm animate-fade-right flex-col rounded-tr-2xl bg-surface/80 backdrop-blur-3xl border-r border-white/10 shadow-[20px_0_60px_-15px_rgba(0,0,0,0.3)] outline-none"
      >
        {children}
      </div>
    </div>
